...
export class CreateFacialTimeRecordDto {
    ...
    @ApiPropertyOptional({ description: 'Threshold opcional para aprovação', example: 0.55 })
    @IsOptional()
    thresholdAccept?: number;

    @ApiPropertyOptional({ description: 'Threshold opcional para revisão', example: 0.45 })
    @IsOptional()
